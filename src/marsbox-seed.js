...
async function upsertGlobal(locale, data) {
  const existing = await strapi.documents('api::global.global').findFirst({ locale });
...
async function upsertLandingPage(locale, landingData, partnerMap) {
